...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindVertexArray(VAO);
			...
			// ------ SUPERIOR ------
			//Cabeza
			model = glm::translate(model, glm::vec3(-0.8f,1.00001f,0.0f));
			...
			//Nariz
			model = glm::translate(model, glm::vec3(-0.97f, 1.0f, 0.0f));
			...
			//Delantera izquierda
			model = glm::translate(model, glm::vec3(-0.7f, -0.70001f, 0.4f));
			...
			//------- PIES -----
			//Pie izquierdo
			model = glm::translate(model, glm::vec3(-0.925f, -0.825001f, 0.4f));
			...
			//Pie izquierdo
			model = glm::translate(model, glm::vec3(0.475f, -0.825001f, 0.4f));
			model = glm::scale(model, glm::vec3(0.25f, 0.15f, 0.2f));
			model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
			glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
			glDrawArrays(GL_TRIANGLES, 0, 36);
