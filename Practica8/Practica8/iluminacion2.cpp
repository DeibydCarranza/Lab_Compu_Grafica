...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(glGetUniformLocation(lightingShader.Program, "colorAlpha"), 1.0f, 1.0f, 1.0, 1.0f); //Para activar la transparencia
		glBindVertexArray(0);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform4f(glGetUniformLocation(lightingShader.Program, "colorAlpha"), 1.0f, 0.0f, 0.0, 0.75f); 
		EsferaSpecular.Draw(lightingShader);
		glDisable(GL_BLEND);  //Desactiva el canal alfa 
		glUniform4f(glGetUniformLocation(lightingShader.Program, "colorAlpha"), 1.0f, 1.0f, 1.0, 1.0f); 
		glBindVertexArray(0);
