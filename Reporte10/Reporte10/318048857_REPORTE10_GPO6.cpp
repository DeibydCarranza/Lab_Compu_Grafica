...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Reporte 10", nullptr, nullptr);
	...
	Shader AnimRaton("Shaders/animRaton.vs", "Shaders/animRaton.frag");
	...
	Model DeskServer((char*)"Models/EscritorioServer/deskServer.obj");
	...
	Model Raton_body((char*)"Models/Raton/body.obj");
	Model Raton_legs1((char*)"Models/Raton/legs1.obj");
	Model Raton_legs2((char*)"Models/Raton/legs2.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 model(1);
			...
			DeskServer.Draw(lightingShader);
		...
		tiempo = glfwGetTime() * 1.1f;
		// Animación del ratón (pendiente)
		lightingShader.Use();
			glBindVertexArray(0);
			...
			Raton_body.Draw(lightingShader);
			Raton_legs1.Draw(lightingShader);
			Raton_legs2.Draw(lightingShader);
		glBindVertexArray(0);
