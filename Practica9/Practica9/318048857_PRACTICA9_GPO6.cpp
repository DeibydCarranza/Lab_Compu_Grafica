...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Representación de salvavidas sin movimiento
		...
		// Anim presenta un desplazamiento en textura desde el shader 
		Anim.Use();
			glBindVertexArray(0);
			// Get location objects for the matrices on the lamp shader (these could be different on a different shader)
		...
		// Anim2 trabaja con un movimiento del salvavidas desde un nuevo shader creado 
		Anim2.Use();
			glBindVertexArray(0);
			// Get location objects for the matrices on the lamp shader (these could be different on a different shader)
